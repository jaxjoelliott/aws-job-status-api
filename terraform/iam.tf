...
resource "aws_iam_role" "getJobStatus_lambda_role" {
  name = "getJobStatus-lambda-role"
...
resource "aws_iam_policy" "getJobStatus_lambda_policy" {
  name        = "getJobStatus-lambda-policy"
  path        = "/"
  description = "Policy for getJobStatus Lambda to allow GetItem"
...
resource "aws_iam_role_policy_attachment" "getJobStatus_lambda_attach" {
  role       = aws_iam_role.getJobStatus_lambda_role.name
  policy_arn = aws_iam_policy.getJobStatus_lambda_policy.arn
}
resource "aws_iam_role_policy_attachment" "getJobStatus_lambda_basic_execution" {
  role       = aws_iam_role.getJobStatus_lambda_role.name
  policy_arn = "arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"
}
